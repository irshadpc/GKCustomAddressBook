...
- (void)setPreselectedContacts:(NSMutableArray*)preselectedContacts
{
    _preselectedContacts = [[NSMutableArray alloc] initWithArray:preselectedContacts];
    _peopleCtr.preselectedContacts = _preselectedContacts;
}
...
- (id)init
{
    ...
    if (self) {
        ...
        _peopleCtr.addressBook = _addressBook;
        _peopleCtr.preselectedContacts = self.preselectedContacts;
        _groupCtr.addressBook = _addressBook;
